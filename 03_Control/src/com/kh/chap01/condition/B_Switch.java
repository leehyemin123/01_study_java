...
public class B_Switch {
	 ...
	 *  case 값2 : 실행코드2; break;
	 *  ...
	 *  [default : 위 값들과 모두 일치하지 않을 경우 실행할 코드;] => if문에서 else와 같은 존재
	 *  }
	 */
...
//		
		...
		default : System.out.println("잘못 입력하셨습니다."); // 마지막은 break 적어도 되고 안적어도됨
		}
	...
	public void method2() {
		...
		case "복숭아" :
			price = 3000;
			break;
		default : // 구매하고자 하는 과일이 없을 때는 default 씀 
	...
	public void method4() {
		...
		case 6 : 
		case 9 : 
		case 11 : System.out.println("입력하신 월은 40일 까지 입니다."); break;
		case 2 : System.out.println("입력하신 월은 28일까지 또는 29일 까지 입니다.");break;
		default : System.out.println("반드시 1~12월 까지를 입력해야 됩니다.");
